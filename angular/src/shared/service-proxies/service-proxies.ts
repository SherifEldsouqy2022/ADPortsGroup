...
export class EmployeeServiceProxy {
     ...
     * @return Success
     */
    getAll(keyword: string | undefined, isActive: boolean | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<EmployeeDtoPagedResultDto> {
    ...
    protected processGetAll(response: HttpResponseBase): Observable<EmployeeDtoPagedResultDto> {
        ...
        if (status === 200) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
                ...
                console.log("*********processGetAll:" + JSON.stringify(result200));
                return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
...
export class EmployeeDtoPagedResultDto implements IEmployeeDtoPagedResultDto {
    ...
    static fromJS(data: any): EmployeeDtoPagedResultDto {
        console.log("*********fromJS:" + JSON.stringify(data));
        data = typeof data === 'object' ? data : {};
    ...
    toJSON(data?: any) {
        ...
        data["totalCount"] = this.totalCount;
        console.log("*********toJSON:" + JSON.stringify(data));
        return data;
    }
