...
{
    public abstract class ADPortsGroupWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ADPortsGroupWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ADPortsGroupWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ADPortsGroupDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ADPortsGroupDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ADPortsGroupDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ADPortsGroupDbContext, Task<T>> func)
        {
            T result;
